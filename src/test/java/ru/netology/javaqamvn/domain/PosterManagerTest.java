...
public class PosterManagerTest {
    ...
    public void lessThanTheLimit() {
        ...
        manager.addFilm("Унесенные ветром");


        String[] expected = {"Унесенные ветром", "Титаник", "Мстители", "Аватар путь воды", "Стажер", "Номер один", "Тролли", "Человек-неведимка", "Джентельмены", "Отель Белград"};
        String[] actual = manager.findLast();
